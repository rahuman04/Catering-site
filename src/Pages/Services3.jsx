          ...
          <div className="grid gap-6 md:grid-cols-1 items-stretch">
            {services.map((service, idx) => (
              <motion.article
                ...
                className={`group h-[420px] rounded-2xl bg-white shadow-sm hover:shadow-lg border border-slate-100 overflow-hidden flex flex-col md:flex-row md:items-stretch ${
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            <p className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-[0.20em] uppercase text-rose-600">
              <span className="h-px w-6 bg-rose-400" /> Testimonials{" "}
              <span className="h-px w-6 bg-rose-400" />
            </p>
            <h2 className="text-3xl md:text-4xl lux-serif text-gray-900">
              What People Say
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto mt-2">
              Real feedback from our recent events.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-700 leading-relaxed">
                “The food and service at our wedding were absolutely
                outstanding! Guests loved every dish.”
              </p>
            </div>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-700 leading-relaxed">
                “Professional setup, delicious food, and on-time delivery. Our
                office team was seriously impressed.”
              </p>
            </div>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-700 leading-relaxed">
                “Their presentation and taste were top-notch. Kids and adults
                both loved the live counters!”
              </p>
            </div>
          </div>
        </div>
