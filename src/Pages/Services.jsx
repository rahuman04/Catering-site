        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-6xl mx-auto px-6 text-white">
            ...
            <div className="mt-6 flex gap-3">
              <Link
                to="/book"
                className="px-5 py-3 bg-amber-600 rounded-md hover:bg-amber-700"
              >
                Book Now
              </Link>
              <a
                href="mailto:info@example.com"
                className="px-5 py-3 border rounded-md hover:bg-white/10"
              >
                Request Quote
              </a>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 ui-font">
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-700 max-w-2xl mx-auto text-sm md:text-base">
              Share your thoughts, ask any doubts, or get quick support for your
              upcoming event.
            </p>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label
                  htmlFor="fb-name"
                  className="text-sm text-gray-700 mb-1 block ui-font font-medium"
                >
                  Name
                </label>
                <input
            ...
            <div className="mt-4 text-center text-xs text-gray-600 ui-font">
              We never share your information. Check our{" "}
